...
export function __mod__async__load(callback) {
    // @ts-ignore
...
function onLoad(req, callback) {
    const config = {
        ...
        'paths': {
            ...
            'vs/basic-languages/dockerfile/dockerfile': __uri('monaco-editor/min/vs/basic-languages/dockerfile/dockerfile'),
            ...
            'vs/basic-languages/handlebars/handlebars': __uri('monaco-editor/min/vs/basic-languages/handlebars/handlebars'),
            ...
            'vs/basic-languages/javascript/javascript': __uri('monaco-editor/min/vs/basic-languages/javascript/javascript'),
            ...
            'vs/basic-languages/objective-c/objective-c': __uri('monaco-editor/min/vs/basic-languages/objective-c/objective-c'),
            ...
            'vs/basic-languages/powershell/powershell': __uri('monaco-editor/min/vs/basic-languages/powershell/powershell'),
            ...
            'vs/basic-languages/typescript/typescript': __uri('monaco-editor/min/vs/basic-languages/typescript/typescript'),
